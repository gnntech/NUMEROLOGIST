  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-bebas tracking-wide mb-4 sm:mb-6 text-white"
          >
            MEANINGFUL GIFTS GUIDED BY NUMBERS
          </h2>
          <p 
            className="text-base sm:text-lg md:text-xl leading-relaxed font-matter max-w-4xl mx-auto mb-6 sm:mb-8 text-white opacity-90"
          >
