...
const PromoSection: React.FC = () => {
  ...
  const carouselImages = [
    { id: 1, image: '/Services.png', alt: 'Promo Banner 1' },
    { id: 2, image: '/Services.png', alt: 'Promo Banner 2' },
    { id: 3, image: '/Services.png', alt: 'Promo Banner 3' },
  ];
    ...
    prevArrow: (
      <button className="slick-prev">
        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white/20 hover:bg-white/40 rounded-full flex items-center justify-center transition-all">
          <img src="/leftarrow.png" alt="Previous" className="w-5 h-5 sm:w-6 sm:h-6" loading="lazy" />
        </div>
      </button>
    ),
    nextArrow: (
      <button className="slick-next">
        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white/20 hover:bg-white/40 rounded-full flex items-center justify-center transition-all">
          <img src="/rightarrow.png" alt="Next" className="w-5 h-5 sm:w-6 sm:h-6" loading="lazy" />
        </div>
      </button>
    ),
        ...
        <div className="flex animate-marquee whitespace-nowrap">
          {[...Array(6)].map((_, i) => (
            <div key={i} className="flex items-center mx-8">
              ...
              <button className="ml-4 bg-white text-red-700 px-4 py-1 rounded font-semibold text-sm hover:bg-gray-100">
                Book Now
              </button>
            </div>
          ))}
