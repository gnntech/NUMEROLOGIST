...
const TestimonialSection: React.FC = () => {
  ...
  // Filter testimonials
  const textTestimonials = data?.testimonials.filter(t => !t.isVideoTestimonial) || [];
  const videoTestimonials = data?.testimonials.filter(t => t.isVideoTestimonial) || [];
  ...
  if (!data || textTestimonials.length === 0) {
    return null;
  }
                  ...
                  <div className="flex items-center justify-between w-full max-w-[240px] sm:max-w-[280px] mt-3">
                    ...
                    <div className="flex flex-col items-center">
                      <div className="flex items-center gap-2 mb-1">
                        {videoTestimonials[currentVideo].avatar && (
